...
public class Invoice {
    ...
    Invoice(String invoiceNumber, String clientID, ArrayList<String> orderNum,
            String issueDate, String dueDate, double total, double profit, double expenses, int shippingCost)
    {
        this.invoiceNumber = invoiceNumber;
        this.clientID = clientID;
        this.dueDate = dueDate;
        this.issueDate = issueDate;
        this.invoiceExpenses = roundTwoDecimals(expenses);
        this.invoiceProfit = roundTwoDecimals(profit);
        this.total = total;
    ...
    public void setInvoiceProfit(double invoiceProfit) {
        this.invoiceProfit = roundTwoDecimals(invoiceProfit);
    }

    public void setInvoiceExpenses(double invoiceExpenses) {
        this.invoiceExpenses = roundTwoDecimals(invoiceExpenses);
    }
